...
<TS version="2.1" language="zh_TW" sourcelanguage="en_US">
    ...
    <extra-po-header-project_id_version>FreeCAD Assembly 4 Language Translations v0.50.4</extra-po-header-project_id_version>
...
select a second datum in the same root container as the first selected datum</source>
        <translation>將選取的基準物件從子零件匯入到根零件組合體中.
這將建立相同類型且具有相同全域位置的新數據
...
with their default names such as:
        ...
        <translation> 選定的基準物體將以其預設名稱匯入到根零件組合中，例如:
</translation>
    </message>
    <message>
