...
class Assembly4Workbench(Workbench):
    ...
    def Initialize(self):
        ...
        FreeCAD.Console.PrintMessage(
            _atr("Asm4", "Initializing Assembly4 workbench")
            + " ("
            + Asm4_version
            + ") ."
        )
        ...
        self.appendToolbar(
            _atr("Asm4", "Selection Filter"), self.selectionToolbarItems()
        )
        self.dot()
    ...
    def ContextMenu(self, recipient):
        ...
        self.appendContextMenu(
            _atr("Asm4", "Assembly"), assemblySubMenu
        )  # add commands to the context menu
        self.appendContextMenu(
            _atr("Asm4", "Create"), createSubMenu
        )  # add commands to the context menu
        self.appendContextMenu("", "Separator")
